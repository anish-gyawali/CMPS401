...
*> IN SEMESTER KEEP TRACK OF NUMBER OF EARNED CREDITS
    MOVE WS-CREDIT TO WSC-CREDIT.
    COMPUTE WSC-SEMESTER-CREDIT = WSC-SEMESTER-CREDIT + WSC-CREDIT.
    
*> IN SEMESTER KEEP TRACK OF NUMBER EARNED QUALITY POINTS.
*> WSC-QPTS IS CALCULATED IN SET-QPTS WHICH IS CALLED FROM SET-WS-RECORD SUBROUTINE.
